...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-12 sm:py-16 lg:py-20">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
        <div className="text-white space-y-6 lg:space-y-8 min-w-0">
          <div className="space-y-3 lg:space-y-4">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.15] pb-1">
              Green Hydrogen
        ...
        <div className="space-y-6 min-w-0">
          <div 
            className="w-full h-auto p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 text-white hover:bg-white/20 hover:border-white/50 transition-all duration-300 cursor-pointer group overflow-hidden"
            onClick={() => navigate('/optimization')}
          >
            <Target className="w-8 h-8 text-hydrogen-green mb-4 group-hover:scale-110 transition-transform" />
          ...
          >
            <MapPin className="w-8 h-8 text-tech-blue mb-4 group-hover:scale-110 transition-transform" />
          ...
          >
            <TrendingUp className="w-8 h-8 text-success-emerald mb-4 group-hover:scale-110 transition-transform" />
